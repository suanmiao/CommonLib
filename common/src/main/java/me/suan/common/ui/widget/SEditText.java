...
public class SEditText extends EditText {
  ...
  private void initAttr(Context context, AttributeSet attributeSet) {
    TypedArray a =
        context.obtainStyledAttributes(attributeSet, me.suan.common.R.styleable.STextView);
    try {
      textStyle = a.getInt(me.suan.common.R.styleable.SEditText_editTextStyle, STYLE_NORMAL);
    } finally {
      a.recycle();
    }
  }
