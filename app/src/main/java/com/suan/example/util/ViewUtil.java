...
import com.suan.example.ui.widget.STextView;
...
public class ViewUtil {
    ...
    public static STextView createTagTextView() {
        ...
        result.setTextColor(context.getResources().getColor(R.color.tag_text));
        result.setBackgroundResource(R.drawable.bg_tag);
        int paddingHorizontal =
                context.getResources().getDimensionPixelSize(R.dimen.tag_bg_padding_horizontal);
        int paddingVertical =
                context.getResources().getDimensionPixelSize(R.dimen.tag_bg_padding_vertical);
    ...
    public static STextView createTipTextView(boolean warning) {
        ...
        STextView result = new STextView(context);
        result.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                context.getResources().getDimensionPixelSize(R.dimen.tip_text_size));
        result.setTextColor(context.getResources().getColor(R.color.pure_white));
        result.setBackgroundResource(warning ? R.drawable.bg_tip_warning : R.drawable.bg_tip_normal);
        int paddingHorizontal =
                context.getResources().getDimensionPixelSize(R.dimen.tip_bg_padding_horizontal);
        int paddingVertical =
                context.getResources().getDimensionPixelSize(R.dimen.tip_bg_padding_vertical);
        result.setPadding(paddingHorizontal, paddingVertical, paddingHorizontal, paddingVertical);
        result.setGravity(Gravity.CENTER);
        return result;
    }
