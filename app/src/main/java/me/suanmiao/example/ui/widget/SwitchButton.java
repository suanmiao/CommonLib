...
public class SwitchButton extends View {
    ...
    private void init() {
        indicatorWidth = getResources().getDimensionPixelSize(me.suanmiao.example.R.dimen.default_switch_indicator_width);
        indicatorHeight = getResources().getDimensionPixelSize(me.suanmiao.example.R.dimen.default_switch_indicator_height);
        baselineHeight = getResources().getDimensionPixelSize(me.suanmiao.example.R.dimen.default_switch_baseline_height);
        baselinePaddingHorizontal = getResources().getDimensionPixelSize(me.suanmiao.example.R.dimen.default_switch_baseline_padding);

        normalIndicatorDrawable = getResources().getDrawable(me.suanmiao.example.R.drawable.ic_button_indicator_normal);
        normalPressedIndicatorDrawable = getResources().getDrawable(me.suanmiao.example.R.drawable.ic_button_indicator_pressed);
        checkedIndicatorDrawable = getResources().getDrawable(me.suanmiao.example.R.drawable.ic_button_indicator_checked_normal);
        checkedPressedIndicatorDrawable = getResources().getDrawable(me.suanmiao.example.R.drawable.ic_button_indicator_checked_pressed);
        baselineDrawable = getResources().getDrawable(me.suanmiao.example.R.drawable.ic_switch_baseline);
    }
