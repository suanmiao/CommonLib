...
public class TipView extends RelativeLayout {
    ...
    public void setTipContent(View content) {
        ...
        content.setTranslationY(-getResources().getDimensionPixelSize(me.suanmiao.example.R.dimen.tip_view_default_height));
    ...
    public class DismissCallback implements Runnable {
        ...
        @Override
        public void run() {
            dismissAnimator = ObjectAnimator.ofFloat(tipContent,TRANSLATION_Y,-getResources().getDimensionPixelSize(me.suanmiao.example.R.dimen.tip_view_default_height));
