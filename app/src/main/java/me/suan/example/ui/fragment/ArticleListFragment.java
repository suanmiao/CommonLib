package me.suan.example.ui.fragment;
...
import me.suan.common.io.http.VolleyCommonListener;
import me.suan.common.io.http.robospiece.api.BaseFormResult;
import me.suan.common.ui.adapter.listview.BaseListAdapter;
import me.suan.common.ui.fragment.AbstractBaseFragment;
import me.suan.common.ui.mvc.ViewModel.BaseViewModel;
import me.suan.common.util.DateUtil;
import me.suan.example.event.BusProvider;
import me.suan.example.io.http.requests.ChannelRequest;
import me.suan.example.ui.adapter.listview.ExampleListAdapter;
...
import me.suan.example.ui.widget.TipView;
...
public class ArticleListFragment extends AbstractBaseFragment {
  ...
  @InjectView(me.suan.example.R.id.list_main_article)
  PtrListview listMainArticle;

  @InjectView(me.suan.example.R.id.tip_main_article)
  TipView tipView;
  ...
  public int getLayoutId() {
    return me.suan.example.R.layout.fragment_article_list;
  }
