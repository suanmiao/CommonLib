package me.suan.example.ui.activity;
...
import me.suan.example.ui.adapter.pager.FragmentPagerAdapter;
import me.suan.example.ui.fragment.ArticleListFragment;
import me.suan.example.ui.widget.SViewPager;
...
public class MainActivity extends BaseToolbarActivity {
    ...
    @InjectView(me.suan.example.R.id.ic_main_actionbar_article)
    ImageView icMainActionbarArticle;
    @InjectView(me.suan.example.R.id.ic_main_actionbar_square)
    ImageView icMainActionbarSquare;
    @InjectView(me.suan.example.R.id.ic_main_actionbar_me)
    ImageView icMainActionbarMe;
    @InjectView(me.suan.example.R.id.toolbar_base)
    Toolbar toolbarMain;
    @InjectView(me.suan.example.R.id.viewpager_main)
    ...
    protected int getContentViewId() {
        return me.suan.example.R.layout.activity_main;
    }
